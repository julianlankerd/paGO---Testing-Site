...
JDEBUG ? $_PROFILER->mark('afterLoad') : null;
require_once JPATH_ADMINISTRATOR . DS . 'modules' . DS . 'mod_pago_dashboard_totals_averages' . DS . 'helper.php';
...
{
	modPagoTotalAvgHelper::averageData($selected);
}
elseif ($selected == 'customdate')
{
	$sale_start_date = $get['sale_start_date'];
$sale_end_date = $get['sale_end_date'];
	modPagoTotalAvgHelper::averageData($selected, $sale_end_date, $sale_start_date);
}
