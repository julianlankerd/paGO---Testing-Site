...
/**
 * Methods supporting a list of mcampaigns records.
 *
 * @package		paGO Commerce
 * @subpackage	com_pago
 * @since		1.6
 */
class PagoModelMCampaigns extends JModelList
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Mcampaigns', $prefix = 'PagoTable', $config = array())
	{
