...
class PagoViewDiscounts extends JViewLegacy
{
	function display( $tpl = null )
	{
		...
		if ( $this->_layout == 'form' ) 
		{
			...
			$params = new PagoParameter( $b_data,  $cmp_path . 'views/discounts/metadata.xml' );
	...
	function toolbars()
	{
		...
		if ( $this->_layout == 'form' ) 
		{
			...
			JToolBarHelper::title(
				JText::_( 'PAGO_DISCOUNTS_MANAGER' ).': <small><small>[ ' . $text.' ]</small></small>'
			);
