...
class PagoViewTax_class extends JViewLegacy
{
	...
	function display_form()
	{
		...
		$title = JText::_('PAGO_TAX_CLASS');
		$desc = JText::_('PAGO_TAX_CLASS_DESC') . $item->pgtax_class_name;
		...
		$params = new PagoParameter($item_bind,  $cmp_path . 'views/tax_class/params.xml');
		JForm::addfieldpath(array($cmp_path . DS . 'elements'));

		if ( !$base_params = $params->render('params', 'base', ''))
			$base_params = JText::_('PAGO_TAX_CLASS_TEMPLATE_ERROR_GENERAL_PARAMETERS');
